...
namespace wp_kb_articles // Root namespace.
{
	...
	if(!class_exists('\\'.__NAMESPACE__.'\\utils_enc'))
	{
		...
		class utils_enc extends abs_base
		{
			 ...
			 */
			public function base64_url_safe_encode($string, array $url_unsafe_chars = array('+', '/'), array $url_safe_chars = array('-', '_'), $trim_padding_chars = '=')
			{
				$string             = (string)$string;
			 ...
			 */
			public function base64_url_safe_decode($base64_url_safe, array $url_unsafe_chars = array('+', '/'), array $url_safe_chars = array('-', '_'), $trim_padding_chars = '=')
			{
			 ...
			 */
			public function set_cookie($name, $value, $expires_after = 31556926)
			{
				if(!($name = trim((string)$name)))
					return; // Not possible.
