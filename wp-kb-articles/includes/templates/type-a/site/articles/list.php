...
<div class="<?php echo esc_attr(__NAMESPACE__.'-list'); ?>">
	...
	<?php if($tab_categories): ?>
		<div class="<?php echo esc_attr(__NAMESPACE__.'-list-tabs'); ?>">
			<ul>
	...
	<?php if($tags): ?>
		<div class="<?php echo esc_attr(__NAMESPACE__.'-list-tags'); ?>">
			<ul>
	...
	<?php if($query->have_posts()): ?>
		<div class="<?php echo esc_attr(__NAMESPACE__.'-list-articles'); ?>">
			<?php while($query->have_posts()): $query->the_post(); ?>
				<div class="<?php echo esc_attr(__NAMESPACE__.'-list-article'); ?>">

					<div class="<?php echo esc_attr(__NAMESPACE__.'-list-article-title'); ?>">
						<a href="<?php echo get_permalink(); ?>"><?php echo esc_html(get_the_title()); ?></a>
					</div>

					<div class="<?php echo esc_attr(__NAMESPACE__.'-list-article-popularity'); ?>">
						<?php echo esc_html($plugin->utils_post->get_popularity(get_the_ID())); ?>
					</div>

					<div class="<?php echo esc_attr(__NAMESPACE__.'-list-article-author'); ?>">
					...
					<div class="<?php echo esc_attr(__NAMESPACE__.'-list-article-tags'); ?>">
					...
					<?php if(comments_open() || get_comments_number()): ?>
						<div class="<?php echo esc_attr(__NAMESPACE__.'-list-article-comments'); ?>">
							<a href="<?php echo esc_attr(get_comments_link()); ?>"><?php echo esc_html(get_comments_number_text()); ?></a>
						</div>
					<?php endif; ?>

					<div class="<?php echo esc_attr(__NAMESPACE__.'-list-article-date'); ?>">
	...
	<?php if($pagination_vars->total_pages > 1): ?>
		<div class="<?php echo esc_attr(__NAMESPACE__.'-list-pagination'); ?>">
			<div class="<?php echo esc_attr(__NAMESPACE__.'-list-pagination-current-page'); ?>">
			...
			<div class="<?php echo esc_attr(__NAMESPACE__.'-list-pagination-pages'); ?>">
				<ul>
					...
					<?php else: // Not possible; this is the first page. ?>
						<li class="<?php echo esc_attr(__NAMESPACE__.'-list-pagination-page-disabled'); ?>"><a href="#">&laquo;</a></li>
					<?php endif; ?>
					...
					for($_i = 1, $_page = $_page_links_start_at_page; $_i <= $_max_page_links && $_page <= $pagination_vars->total_pages; $_i++ && $_page++): ?>
						<li<?php if($_page === $pagination_vars->current_page): ?> class="<?php echo esc_attr(__NAMESPACE__.'-list-pagination-page-current'); ?>"<?php endif; ?>>
					...
					<?php else: // Not possible; this is the last page. ?>
						<li class="<?php echo esc_attr(__NAMESPACE__.'-list-pagination-page-disabled'); ?>"><a href="#">&raquo;</a></li>
					<?php endif; ?>
				</ul>
			</div>
		</div>
	...
	<div class="<?php echo esc_attr(__NAMESPACE__.'-list-attr'); ?>" data-attr="<?php echo esc_attr($plugin->utils_enc->encrypt(serialize($attr_))); ?>"></div>
